...
| FGFA + DFA (Vanilla) |    R-50-DC5     |  pytorch  |   7e    | 4.10        | 8.2              | 73.9 | [config](fgfa_dyn_faster_rcnn_r50_dc5_1x_imagenetvid.py) | Coming soon, stay tuned! |
| FGFA + DFA (Deformable) |    R-50-DC5     |  pytorch  |   7e    | 4.10        | 7.9              | 74.1 | [config](fgfa_dyn_cs_faster_rcnn_r50_dc5_1x_imagenetvid.py) | Coming soon, stay tuned! |
